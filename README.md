...
Welcome to my Manual QA repository. This project demonstrates a full testing lifecycle (STLC) for the **OrangeHRM** system, an open-source HR management platform. 

The goal of this project was to analyze requirements, plan the testing strategy, and execute various testing types (Sanity, Regression, Functional) to ensure system stability.
...
## 🎯 Testing Highlights
* **Types of Testing:** Functional, UI/UX, Negative Testing, Boundary Value Analysis, and Regression.
* **Tools:** Chrome DevTools (for root cause analysis), Excel, and Word for professional documentation.
* **Methodology:** Agile-oriented testing approach.
